  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (drawnSeconds > 0) {
      canvas.drawArc(
        ...
        startAngle, sweepAngle, true, paintArc,
      );
    }
    ...
    for (int i = 0; i < maxScaleSeconds; i += 5) {
      ...
      if (indMode == "dot") {
        ...
        textPainter.text = TextSpan(text: '$i', style: TextStyle(fontSize: relativeFontSize, color: globalIndicatorColor.value, fontWeight: FontWeight.bold));
        textPainter.layout();
...
class SevenSegmentDigit extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget segment(bool active) => Container(margin: EdgeInsets.all(gap), decoration: BoxDecoration(color: active ? color : color.withOpacity(0.08), borderRadius: BorderRadius.circular(t / 2)));
      ...
      builder: (context, constraints) {
        ...
        return AnimatedBuilder(
          ...
          builder: (context, child) {
            ...
            String indicatorMode = globalIndicatorMode.value.toLowerCase();
