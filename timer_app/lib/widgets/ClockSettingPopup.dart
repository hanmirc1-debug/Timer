          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: const Text("시계 설정", textAlign: TextAlign.center, style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
              ),
              // 2. 스크롤 본문
              Expanded(
                child: SingleChildScrollView(
                  ...
                  child: AnimatedBuilder(
                    ...
                    animation: Listenable.merge([globalDisplayMode, globalIndicatorMode]),
                    builder: (context, _) {
                      return Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          const Text("표시 방식", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.grey)),
                          ...
                          const Text("눈금 스타일", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.grey)),
                          RadioListTile<String>(
